...
client = None
context = "The following is a conversation with an AI Mental Support Chat Bot. The Chatbot is helpful, emphatic, clever, and very friendly.\n\nHuman: Hello can you please health me as a therapist?\nAI: I am an AI created for Mental Support. How can I help you today? "
conversation = {
    "Conversation": ["Who are you?", "Hi! I am Taipy Care. How can I help you today?"]
}
...
def on_init(state: State) -> None:
    ...
    """
    state.context = "The following is a conversation with an AI Mental Support Chat Bot. The Chatbot is helpful, emphatic, clever, and very friendly.\n\nHuman: Hello can you please health me as a therapist?\nAI: I am an AI created for Mental Support. How can I help you today?"
    state.conversation = {
        "Conversation": ["Who are you?", "Hi! I am Taipy Care. How can I help you today?"]
    }
